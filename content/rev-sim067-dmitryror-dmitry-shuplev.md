...
![pic](https://github.com/raketareview/simulation_review/blob/master/content/resources/rev-sim067/img1.png)
...
❌ Иерархия класов Entity построена неправильно, класс-родитель содержит методы, которые должны появляться только у наследников.
...
Слабое понимание основ ООП: наследование, иерархия классов. 
