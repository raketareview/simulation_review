...
- Нарушение SRP 
  - Реализует процесс еды Волкозайца- несуществующей в проекте сущности
  - Зависит от представления: `System.out.println("Зайца сьели!");`
...
У травы есть жизни, которые потребляет Заяц.  
И у зайца на уровне `Creature` есть жизни, которые потребляет Волк.
...
+ 👍 Только инициирует движения существ, отлично.
