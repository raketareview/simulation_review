...
Тогда можно сделать семейство родственных классов поиска, объединенных общим интерфейсом.
...
- Стандартным явлениям давай стандартные названия. Это простая фабрика
```java
...
Второй майн пусть запускает игру сразу с картой размером 10x10 и т.д.  
