...
- В классе может быть только один метод, который называется так же, как сам класс- это конструктор. 
А этот метод не конструктор, хотя называется точно так же, как его класс
```
