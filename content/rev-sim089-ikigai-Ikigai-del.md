...
**5. class Point extends Point2D из пакета java.awt.geom в качестве координаты**
...
- Ширина и высота во время жизненного цикла Доски не меняются- они должны быть `final`. 
...
public void render()
```
Поотому что это- дополнительная причина для изменения. Например, при добавлении 
...
**8. class Tree/Rock extends Entity**
...
**11. class InitAction_PopulateWorld implements Action**
...
- Да, ширину и высоту нужно брать из самой Доски- только так и никак иначе
```
...
**14. Алгоритм поиска, которого нет** 

В проекте нет поиска пути, как такового. Существа могут хордить к ближайшей пище по прямой. 
...
**15. Нет многопоточности, ТЗ не соответствует** 
