...
![pic](https://github.com/raketareview/simulation_review/blob/master/content/resources/rev-sim105/img1.jpg)
...
- Этот класс не должен содержать в себе `main`, отделяй создание объекта от его использования.  
*"ЧК", гл.11*
