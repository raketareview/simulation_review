...
- Лишняя путаница на ровном месте
```java
...
**13. Множество других других классов в пакете**
...
- Консольный ввод это не контроллер, это представление.
...
Этот класс не имеет отношения не только к архитектуре MVC, но и к ООП в целом.
...
Не видно понимания сути MVC: ответственности слоёв перемешаны, отсутствует `Dependency injection`, контроллеры-утилиты.
