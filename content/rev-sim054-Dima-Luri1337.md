...
Для изучения декомпозиции посмотреть ролики Сергея про шахматы.   
Посмотреть ролики Немчинского про DRY, инкапсуляцию, наследование, полиморфизм, SRP, "Почему нельзя возвращать NULL?".
