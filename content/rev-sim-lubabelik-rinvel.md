...
5. Не передавай тернарники во входящие аргументы метода- это читается просто ужасно
```
...
8. Нарушение SRP. Карта не должна решать, можно ли вставлять существо в ячейку, если там уже находится другое существо, или нельзя
```
...
13. class SpawnAction extends Action
