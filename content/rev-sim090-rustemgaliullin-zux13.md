...
Масштабная реализация. Применяются принципы реактивного программирования
...
Это нарушает концепцию экшенов, описанную в ТЗ- там Actions про другое!
...
а не являются деталями реализаций мелких подробностей алгоритма совершения хода, как сделано здесь.
...
Но тут меню много, поэтому не ок. 
Тем более, учитывая общий накал ООП в проекте.
...
Типа, все реактивные компоненты и экземпляр класса `Simulation` вместе являют собой "Процесс симуляции", а значит и фабрика симуляции создает всех их скопом.
