...
- Названия полей должны как можо лучше объяснять, что они хранят
```
GameMap.x
GameMap.y 
...
Карта *здесь* должна хранить и существа и их координаты. 
Примерно, так:
```
...
Но кто сказал, что эти координаты обязательно будут находиться в пределах карты?
