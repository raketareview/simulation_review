...
![pic](https://github.com/raketareview/simulation_review/blob/master/content/resources/rev-sim135/img0.png) 
...
- Если нужно что-то установить, то пиши "set" а не "setup"
```java
void SetUpEntity(Coordinates coordinates, Entity entity) {
...
- Это не константа, а изменяемое поле 
```java
HP++;
...
Если в самой Карте этих методов нет, значит клиенты выполняют такие действия со внутренностями Карты напрямую.  
