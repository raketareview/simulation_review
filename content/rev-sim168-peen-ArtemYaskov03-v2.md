...
Всегда явно указывай модификатор доступа, даже когда она protected
```java
public class Way {
...
Публичные методы стоять выше вспомогательных приватных методов.  
...
Но эти классы не соответствует описанию классов Action's в ТЗ:
```java
Actions #
