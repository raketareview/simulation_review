...
1. Карта распечатывается неправильно- c поворотом на 90 градусов
...
- Класс не соответствует описание паттерну "Command".

Сейчас `SpawnAction` у тебя это просто сборник функций, сделанный в стиле процедурного программирования.  
В нем много публичных методов
```java
