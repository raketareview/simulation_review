...
- Этот класс здесь не нужен, потому что он означает положение координаты относительно нуля.  
...
Поэтому оптимизация скорости выполнения некоторых операций здесь в ущерб архитектуре это антипаттерн "Преждевременная оптимизация".
